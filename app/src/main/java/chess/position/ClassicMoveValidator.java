...
public class ClassicMoveValidator implements Validator{
    ...
    public MoveResult checkMove(Board board, Move move, PlayerColor currentPlayerColor) throws OutOfBoundsException, NotMovingAPieceException, MovementException, PathBlockedException, CannotTakePieceException, SelfCheckException {
        ...
        if (fromPosition.compareTo(toPosition) == 0) throw new NotMovingAPieceException();
    ...
    private void checkIllegalMovementEvaluators(Board board,Move move, Set<Move> moves, Piece piece) throws MovementException, NotMovingAPieceException, OutOfBoundsException, CannotTakePieceException, PathBlockedException, SelfCheckException {
